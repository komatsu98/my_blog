...
Lập trình hướng chức năng là một **mô hình lập trình**, có nghĩa là đó là một cách suy nghĩ về kiến trúc phần mềm dựa trên một số nền tảng cơ bản, xác định theo các nguyên tắc (được liệt kê ở trên). Other examples of programming paradigms include object oriented programming and procedural programming.
